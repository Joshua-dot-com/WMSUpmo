            ...
            <main class="p-6">
                            ...
                            <table class="w-full text-sm">
                                <thead>
                                    <tr class="border-b">
                                        ...
                                        <th class="h-12 px-4 text-left font-medium text-gray-500">Reason</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="p-4 font-medium">Jessica Taylor</td>
                                        <td class="p-4">jessica.taylor@example.com</td>
                                        <td class="p-4">Marketing</td>
                                        <td class="p-4">2023-03-14</td>
                                        <td class="p-4">Role change</td>
                                        <td class="p-4 text-right">
                                            <div class="flex justify-end gap-2">
                                                <button class="btn btn-destructive btn-sm">
                                                    <i class="fas fa-trash-alt mr-1"></i>
                                    ...
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="p-4 font-medium">Andrew Clark</td>
                                        <td class="p-4">andrew.clark@example.com</td>
                                        <td class="p-4">Sales</td>
                                        <td class="p-4">2023-03-13</td>
                                        <td class="p-4">Left company</td>
                                        <td class="p-4 text-right">
                                            <div class="flex justify-end gap-2">
                                                <button class="btn btn-destructive btn-sm">
                ...
                <div class="bg-white rounded-lg border shadow-sm mt-6">
                    <div class="p-6 border-b">
                        <h2 class="text-lg font-semibold">Bulk User Management</h2>
                    </div>
                    <div class="p-6">
                        <div class="mb-6">
                            <p class="text-sm text-gray-500 mb-4">Select users to perform bulk actions such as deactivation or deletion.</p>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm">
                                <thead>
                                    <tr class="border-b">
                                        <th class="h-12 w-12 px-4 text-left">
                        ...
                        <div class="flex flex-col md:flex-row items-center justify-between py-4">
                            <div class="text-sm text-gray-500 mb-4 md:mb-0">
                                Showing <strong>1-5</strong> of <strong>42</strong> users
                            </div>
