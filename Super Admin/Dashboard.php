        ...
        <div class="flex-1 ml-64">
            ...
            <main class="p-6">
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="bg-white rounded-lg border shadow-sm p-6">
                        <div class="flex items-center justify-between pb-2">
                            <div class="text-sm font-medium">Granted Access</div>
                            <i class="fas fa-user-check text-gray-400"></i>
                        </div>
                        <div class="text-2xl font-bold">1,132</div>
                        <p class="text-xs text-gray-500 mt-1">
                            90.7% approval rate
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-lg border shadow-sm p-6">
                        <div class="flex items-center justify-between pb-2">
                            <div class="text-sm font-medium">Rejected Requests</div>
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mt-4">
                    <!-- Recent Activity -->
                    <div class="bg-white rounded-lg border shadow-sm lg:col-span-4">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <div class="mr-4 rounded-full p-2 bg-red-100">
                                        <i class="fas fa-times-circle text-red-600"></i>
                                    </div>
                                    <div class="flex-1 space-y-1">
                                        <p class="text-sm font-medium leading-none">
                                            Jane Smith was rejected
                                        </p>
                                        <p class="text-sm text-gray-500">
                                            15 minutes ago
                                        </p>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-1 space-y-1">
                                        <p class="text-sm font-medium leading-none">
                                            Robert Johnson was granted access
                                        </p>
                                        <p class="text-sm text-gray-500">
                                            45 minutes ago
                                        </p>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-1 space-y-1">
                                        <p class="text-sm font-medium leading-none">
                                            Emily Davis was granted access
                                        </p>
                                        <p class="text-sm text-gray-500">
                                            1 hour ago
                                        </p>
