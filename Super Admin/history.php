                ...
                <div class="bg-white rounded-lg border shadow-sm">
                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-4 mb-4 flex-wrap">
                            <button class="btn btn-primary-light btn-sm">All</button>
                            <button class="btn btn-outline btn-sm">Granted</button>
                            <button class="btn btn-outline btn-sm">Rejected</button>
                        </div>
                            ...
                            <table class="w-full text-sm">
                                ...
                                <tbody>
                                    <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <td class="p-4">2023-03-10</td>
                                        <td class="p-4">2023-03-11</td>
                                        <td class="p-4">
                        ...
                        <div class="flex flex-col md:flex-row items-center justify-between py-4">
                            <div class="text-sm text-gray-500 mb-4 md:mb-0">
                                Showing <strong>1-7</strong> of <strong>42</strong> entries
                            </div>
