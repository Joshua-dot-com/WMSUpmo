...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-4"></body>
    <div class="max-w-md w-full">
        <div class="text-center mb-8">
            <img src="/PMO/Assets/wmsu.png" alt="Logo" class="h-20 w-20 mx-auto rounded-full object-cover">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-4">Equipment Management System Admin</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Sign in to your account</p>
        </div>

        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <div id="error-message" class="hidden bg-red-100 dark:bg-red-200 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
...
<?php if (isset($_GET['error'])): ?>
    <div class="text-red-600 bg-red-100 border border-red-300 p-2 rounded mb-4">
        <?= htmlspecialchars($_GET['error']) ?>
    </div>
<?php endif; ?>

<?php if (isset($_GET['already_requested'])): ?>
    <div class="text-yellow-700 bg-yellow-100 border border-yellow-300 p-2 rounded mb-4">
        A reset link has already been sent. Please wait <?= (int) $_GET['minutes_remaining'] ?> minutes before trying again.
    </div>
<?php endif; ?>
            ...
            <form id="loginForm" class="space-y-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" id="email" name="email" required class="pl-10 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100" placeholder="you@example.com">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password" name="password" required class="pl-10 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100" placeholder="••••••••">
                    </div>
                </div>
...
<div id="forgotPasswordModal" class="fixed inset-0 z-50 hidden bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-sm relative">
        ...
        <!-- Form -->
        <form id="forgotPasswordForm" method="POST" action="admin-send-reset-email.php" class="space-y-4">
            <div>
    ...
    <script>
        // Prevent going back to the previous page using the back button or browser's arrows
        ...
        document.getElementById('loginForm').addEventListener('submit', function (event) {
            ...
            // Send the POST request to the PHP login script
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = "/PMO/Super-Admin/Dashboard.php";
                } else {
                    // Show error message
