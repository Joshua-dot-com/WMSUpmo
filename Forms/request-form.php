...
<head>
  ...
  <style>
    ...
    body {
      ...
      font: 100% 1.125em 'Poppins', sans-serif;
    }
...
<body class="py-8 px-4 sm:px-6 md:px-8 min-h-screen">
    ...
    <div class="flex">
      ...
      <div class="ml-3">
        ...
        <div class="mt-1 text-sm text-blue-700">
          <p>Click on highlighted areas to fill in the required information. <span class="bg-ics-input px-2 py-0.5 rounded border border-blue-200">Blue fields</span> are optional and <span class="bg-ics-required px-2 py-0.5 rounded border border-red-200">red fields</span> are required.</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="overflow-x-auto mb-8">
        <table class="w-full border-collapse ics-table">
          ...
          <tbody>
            ...
            <!-- Total Row -->
            <tr class="bg-gradient-to-r from-gray-100 to-gray-50 font-medium">
  ...
  <script>
    function updateTotal(row) {
      ...
      let amount = parseFloat(document.  || 0;
    ...
    function updateGrandTotal() {
      let total1 = parseFloat(document.getElementById("total-1").value) || 0;
      let total2 = parseFloat(document.getElementById("total-2").value) || 0;
      document.getElementById("grand-total").innerText = "P " + (total1 + total2).toFixed(2);
    }
