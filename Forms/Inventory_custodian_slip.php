        ...
        <table class="w-full border-collapse ics-table">
          <thead>
            ...
            <tr class="hover:bg-gray-50 transition-colors duration-150">
              ...
              <input type="number" id="qty-1" value="1" min="1" class="input-field required-field w-full px-3 py-2 text-gray-700 text-sm" onchange="updateTotal(1)" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="e.g., piece" class="input-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="e.g., Headset" class="input-field required-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <textarea placeholder="Enter description" class="input-field w-full px-3 py-2 text-gray-700 text-sm resize-none"></textarea>
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="e.g., 2-02-01-050" class="input-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="Enter Inventory No." class="input-field required-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="e.g., 1 year" class="input-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="number" id="amount-1" value="0.00" step="0.01" class="input-field required-field w-full px-3 py-2 text-gray-700 text-sm text-right" onchange="updateTotal(1)" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="number" id="total-1" value="0.00" class="w-full px-3 py-2 text-gray-700 text-sm text-right bg-gray-50" readonly />
              </td>
            </tr>
            <tr class="hover:bg-gray-50 transition-colors duration-150">
              <td class="border border-ics-border px-4 py-3">
              <input type="number" id="qty-2" value="1" min="1" class="input-field w-full px-3 py-2 text-gray-700 text-sm" onchange="updateTotal(2)" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="e.g., piece" class="input-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="e.g., Flash Drive" class="input-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <textarea placeholder="Enter description" class="input-field w-full px-3 py-2 text-gray-700 text-sm resize-none"></textarea>
              </td>
              ...
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="Enter Inventory No." class="input-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="text" placeholder="e.g., 1 year" class="input-field w-full px-3 py-2 text-gray-700 text-sm" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="number" id="amount-2" value="0.00" step="0.01" class="input-field w-full px-3 py-2 text-gray-700 text-sm text-right" onchange="updateTotal(2)" />
              </td>
              <td class="border border-ics-border px-4 py-3">
              <input type="number" id="total-2" value="0.00" class="w-full px-3 py-2 text-gray-700 text-sm text-right bg-gray-50" readonly />
              </td>
            </tr>
