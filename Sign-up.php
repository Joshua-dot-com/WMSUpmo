    ...
    <p class="text-gray-600 mt-1 font-bold">Register your account</p>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form id="signup-form" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="select-wrapper relative">
                        ...
                        >
                            ...
                            <option value="Administrative Officials">Administrative Official</option>
                        </select>
                        <!-- Custom arrow -->
                ...
                <!-- Administrative Officials Roles Dropdown - For Administrative Officials Officials role -->
                <div id="adminRolesContainer" class="conditional-field hidden">
                    <label for="adminRolesSelect" class="block text-sm font-medium text-gray-700 mb-1">Administrative Officials Role</label>
                    <div class="select-wrapper relative">
                        <select 
                            id="adminRolesSelect" 
                            name="adminRole" 
                            class="custom-select w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        >
                            <option value="" disabled selected>Select your Administrative Official Role</option>
